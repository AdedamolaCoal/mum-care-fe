...
@Component({
  selector: 'app-style-05',
  standalone: true,
  imports: [CommonModule, NgApexchartsModule, TopBannerComponent, OptionsHorizComponent, DropdownComponent],
  templateUrl: './style-05.component.html'
})
export class Style05Component {
  stats = statesData
  statChartOptions!: ChartOptions
  balanceChartOptions!: ChartOptions
  browserChartOptions!: ChartOptions
  latestTransactions
  constructor() {
    this.latestTransactions = new TableService()
    this.latestTransactions.initialize(latestTransactions.slice(0,12), 12)
  }
